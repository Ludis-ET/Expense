...
class AnalyticsCommitment {
  ...
  factory AnalyticsCommitment.fromJson(Map<String, dynamic> j) => AnalyticsCommitment(
        id: asStr(j['id'], ''),
        name: asStr(j['name'], ''),
...
class AnalyticsCounterparty {
  ...
  factory AnalyticsCounterparty.fromJson(Map<String, dynamic> j) => AnalyticsCounterparty(
        name: asStr(j['name'], ''),
...
class AnalyticsPageData {
  ...
  factory AnalyticsPageData.fromJson(Map<String, dynamic> j) {
    ...
    return AnalyticsPageData(
      ...
      deltaExpensePct: cf['deltaExpensePct'] == null ? null : asNum(cf['deltaExpensePct']),
      ...
      shareOfIncome:
          commitments['shareOfIncome'] == null ? null : asNum(commitments['shareOfIncome']),
      ...
      avgDaysToPlan: wishlist['avgDaysToPlan'] == null ? null : asNum(wishlist['avgDaysToPlan']),
      avgDaysToBuy: wishlist['avgDaysToBuy'] == null ? null : asNum(wishlist['avgDaysToBuy']),
      ...
      counterparties: mapList(ledger['counterparties'], AnalyticsCounterparty.fromJson),
...
class CategoryTotals {
  CategoryTotals({required this.currency, required this.total, required this.items});
...
class CategoryTotalsItem {
  CategoryTotalsItem({required this.amount, required this.count, required this.pct, this.category});
  ...
  factory CategoryTotalsItem.fromJson(Map<String, dynamic> j) => CategoryTotalsItem(
        category: Ref.maybe(j['category']),
        amount: asStr(j['amount']),
        count: asInt(j['count']),
        pct: asNum(j['pct']),
...
class IncomeVsExpensePoint {
  ...
  factory IncomeVsExpensePoint.fromJson(Map<String, dynamic> j) => IncomeVsExpensePoint(
        month: asStr(j['month'], ''),
...
class SpendHeatmapData {
  SpendHeatmapData({required this.currency, required this.year, required this.days});
  final String currency;
  final int year;
