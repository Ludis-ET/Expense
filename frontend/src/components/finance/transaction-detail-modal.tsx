  ...
  return (
    <div className="flex min-h-14 items-center gap-3 border-b border-border px-4 py-3 last:border-0">
      ...
      <div className="min-w-0 flex-1 py-0.5">
        ...
        <p className={cn("text-sm font-medium leading-snug", valueClass)}>
          {value}
        </p>
      </div>
    </div>
    ...
    >
      <div className="space-y-5">
          ...
          <div className="overflow-hidden rounded-2xl border border-border bg-surface">
            <div className="flex items-center gap-3 border-b border-border px-4 py-3">
              <span
                ...
                style={{
                  backgroundColor: `${tx.budget.color ?? "#6366f1"}22`,
                  color: tx.budget.color ?? "#6366f1",
                }}
              >
              ...
              <div className="text-right">
                ...
                <p className="text-xs text-muted">
                  {tx.budgetCycle !== null && tx.budgetCycle !== undefined
                    ? `Cycle ${tx.budgetCycle}`
                    : "Plan spend"}
                </p>
              </div>
            </div>
        ...
        <div className="rounded-xl border border-border overflow-hidden divide-y divide-border">
          ...
          {tx.note && (
            <DetailRow icon={FileText} label="Note" value={tx.note} />
          )}
        ...
        <p className="pt-1 text-center font-mono text-[10px] text-muted/50">
          {tx.id}
        </p>
