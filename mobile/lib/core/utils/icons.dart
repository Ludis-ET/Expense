...
const iconNames = <String>[
  'banknote', 'bike', 'book-open', 'briefcase', 'bus', 'car', 'circle',
  'circle-ellipsis', 'clapperboard', 'coffee', 'credit-card', 'dumbbell',
  'flame', 'fuel', 'gamepad-2', 'gift', 'graduation-cap', 'hand-coins',
  'heart', 'heart-pulse', 'home', 'landmark', 'laptop', 'music', 'paw-print',
  'phone', 'piggy-bank', 'pill', 'plane', 'plug-zap', 'plus-circle', 'repeat',
  'shield', 'shirt', 'shopping-bag', 'shopping-basket', 'shopping-cart',
  'smartphone', 'sparkles', 'store', 'target', 'tree-palm', 'trending-up',
  'users', 'utensils', 'wallet', 'wifi', 'wrench',
];
